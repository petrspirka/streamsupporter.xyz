...
namespace NewStreamSupporter.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(64, ErrorMessage = "The username must be at least 5 characters long and 64 characters long at most", MinimumLength = 5)]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        return RedirectToPage("RegisterConfirmation", new { success = false });
                    }
