...
namespace NewStreamSupporter.Migrations
{
    ...
    [Migration("20230503112650_Updated UnclaimedCurrencyModel to include concurrency check and added default Name value as its unused")]
    partial class UpdatedUnclaimedCurrencyModeltoincludeconcurrencycheckandaddeddefaultNamevalueasitsunused
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NewStreamSupporter.Data.DonationGoalModel", b =>
                {
                    ...
                    b.Property<double>("AnimationLength")
                        .HasColumnType("REAL");
                    ...
                    b.Property<bool>("DoesTextHaveShadow")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NewStreamSupporter.Data.RewardModel", b =>
                {
                    ...
                    b.Property<string>("TriggeredAlertId")
                        .HasColumnType("TEXT");

                    b.Property<string>("TriggeredMarqueeId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TriggeredAlertId");

                    b.HasIndex("TriggeredMarqueeId");
            ...
            modelBuilder.Entity("NewStreamSupporter.Data.RewardModel", b =>
                {
                    ...
                    b.HasOne("NewStreamSupporter.Data.AlertModel", "TriggeredAlert")
                        .WithMany()
                        .HasForeignKey("TriggeredAlertId");

                    b.HasOne("NewStreamSupporter.Data.MarqueeModel", "TriggeredMarquee")
                        .WithMany()
                        .HasForeignKey("TriggeredMarqueeId");

                    b.Navigation("Owner");

                    b.Navigation("TriggeredAlert");

                    b.Navigation("TriggeredMarquee");
                });
